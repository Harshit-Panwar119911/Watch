...
import java.util.GregorianCalendar;
 class Psdude extends JPanel implements Runnable
{
Thread thread;
int i,j,k,p=0,q=0;
...
private void clockLayout(Graphics g)//layout of calender
{
...
//STRING WRITTEN TEXT
g.setColor(Color.blue);
g.drawString("clock design by Harshit Panwar",300,100);
